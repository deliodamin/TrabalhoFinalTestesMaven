...
public class verificaDisponibilideDeUsuario {
  ...
  @Test
  public void testVerificaAlteracaoIdioma() throws Exception {
    ...
    assertEquals("Admin", driver.findElement(By.xpath("//div[@id='cssmenu']/ul/li[2]/a/span")).getText());
    driver.findElement(By.xpath("//div[@id='cssmenu']/ul/li[2]/a/span")).click();
  }
