...
public class verificaElementosAoIniciar {
  ...
  public void testVerificaElementosAoIniciar() throws Exception {
    ...
    try {
      assertEquals("Sair", driver.findElement(By.xpath("(//a[@id='buscaA']/div)[2]")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertEquals("Estatísticas", driver.findElement(By.xpath("(//a[@id='suporteA']/div)[5]")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
  }
